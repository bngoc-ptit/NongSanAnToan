package nongsanantoan.admin.controller;
...
import nongsanantoan.admin.service.AccountService;
import nongsanantoan.admin.service.EmployeeService;
import nongsanantoan.admin.validator.EmployeeValidator;
import nongsanantoan.model.Admin;
import nongsanantoan.model.Employee;
		...
		try {
			...
			if (username.equals(account.getFullName())) {
				...
				try {
					...
					helper.setFrom("Nông Sản An Toàn <ngoc96.ptithcm@gmail.com>");
					helper.setTo(account.getUsername());
					helper.setReplyTo("Nông Sản An Toàn <ngoc96.ptithcm@gmail.com>");
