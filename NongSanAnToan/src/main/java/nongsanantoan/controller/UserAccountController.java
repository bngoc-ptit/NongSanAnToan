...
import nongsanantoan.admin.controller.ShopController;
import nongsanantoan.model.Customer;
		...
		try {
			...
			// Gửi mật khẩu qua mail
				...
				String text = "Xin chào: " + customer.getFullName()
						+ "<br> Bạn đã đăng ký thành công tài khoản tại Nông Sản An Toàn của chúng tôi"
