package nongsanantoan.controller;
...
import nongsanantoan.model.Category;
import nongsanantoan.model.Producer;
import nongsanantoan.model.Product;
import nongsanantoan.other.ShoppingCart;
...
public class UserHomeContoller {
	...
	public String feedback(ModelMap model, @RequestParam("name") String name, @RequestParam("email") String email,
		...
		try {
			...
			helper.setTo("ngoc96.ptithcm@gmail.com");
			...
			model.addAttribute("message", "Gửi phản hồi thành công. Cảm ơn bạn đã đóng góp ý kiến cho Nông Sản An Toàn.");
		} catch (Exception ex) {
