...
<div class="sidebar" data-background-color="while"
	...
	<div class="sidebar-wrapper"  >
		<div class="logo" style="margin: 0 0px;"> 
		<a href="admin/home" > 
		
   			<img class="light-logo" alt="homepage" src="lite/images/logo-light-icon.png" >
		...
		<ul class="nav" style="color: #EB5E28">
			...
			<<li class="active-pro"><a
				href="https://www.facebook.com/ngoc95.nguyenbao" target="blank"> <i
					class="ti-export"></i>
					<p>
