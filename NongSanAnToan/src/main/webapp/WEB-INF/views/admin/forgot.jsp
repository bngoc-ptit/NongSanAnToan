...
<body>
	...
	<div class="main"
		...
		<div class="container">
			<h1 class="logo cursive">Nông Sản An Toàn</h1>
		...
		<div class="footer">
			<div class="container">
				...
				<a href="https://www.facebook.com/ngoc95.nguyenbao">Nguyễn Bảo Ngọc</a>.
				<s:message code="admin.login.contact" />
				<a href="https://www.facebook.com/ngoc95.nguyenbao"><s:message
