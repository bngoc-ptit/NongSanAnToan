		...
		<div class="container">
			<div class="row">
				...
				<div class="span9">
					...
					<h3>
						Tên Sản Phẩm <small class="pull-right"> products are
							available </small>
					</h3>
					<hr class="soft">
					<p>Hoạt động với phương châm "Sự hài lòng của khách hàng là niềm vui
						của Nông Sản An Toàn"", chúng tôi luôn cố gắng để từng bước
						cải thiện chất lượng dịch vụ</p>
					<hr class="soft">
